...
/*public function parser(){
        ...
        //$html = file_get_html('http://ru.euronews.com/sport/');
        //file_put_contents('tmp/tt.txt', $html);

        $html = file_get_html('tmp/tt.txt');

        $e = $html->find('.subcategoryList', 0);
        foreach($e->find('ul li .themeArtTitle') as $row){
        ...
        //print_r($tt);
        // Find all images
        /*foreach($html->find('.subcategoryList ul li') as $element){
